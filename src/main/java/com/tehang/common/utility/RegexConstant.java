...
public final class RegexConstant {
   ...
   * 邮箱正则
   */
  public static final String EMAIL_PATTERN = "[\\w!#$%&'*+/=?^_`{|}~-]+(?:\\.[\\w!#$%&'*+/=?^_`{|}~-]+)*@(?:[\\w](?:"
      + "[\\w-]*[\\w])?\\.)+[\\w](?:[\\w-]*[\\w])?";
   ...
   */
  public static final String ISO_DATE_REGEX_OR_EMPTY = "(((((19|20)\\d{2})-(0?[13-9]|1[012])-(0?[1-9]|[12]\\d|30))|(((19|20)\\d{2})-(0?[13578]|1[02])-31)"
   ...
   * 日期正则: yyyy-MM-dd
   */
  public static final String DATE_PATTERN = "(?:(?!0000)[0-9]{4}-(?:(?:0[1-9]|1[0-2])-"
   ...
   */
  public static final String DATE_PATTERN_OR_EMPTY = "(?:(?!0000)[0-9]{4}-(?:(?:0[1-9]|1[0-2])-"
      + "(?:0[1-9]|1[0-9]|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[0-9]{2}"
      + "(?:0[48]|[2468][048]|[13579][26])|(?:0[48]|[2468][048]|[13579][26])00)-02-29)|";
   ...
   */
  public static final String LOCAL_DATE_TIME_PATTERN = "^((((19|20)\\d{2})-(0?[13-9]|1[012])-(0?[1-9]|[12]\\d|30))|(((19|20)\\d{2})-(0?[13578]|1[02])-31)|(((19|20)\\d{2})-0?2-(0?[1-9]|1\\d|2[0-8]))|((((19|20)([13579][26]|[2468][048]|0[48]))|(2000))-0?2-29))\\s(2[0-3]|[01][0-9]):([0-5][0-9])(\\\\.[0-9]+)?(Z)?$";
