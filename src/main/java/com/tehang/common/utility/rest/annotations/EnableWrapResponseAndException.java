 ...
 *
 * 用法：
 * 1. 在需要包装的Controller上添加WrapResponse, WrapException注解, 一般加在Controller的基类上；
 * 2. 在不需要包装的Controller方法上添加DisableWrapResponse;
 * 3. 在Application.java上添加本注解：EnableWrapResponseAndException
 */
...
@Inherited
@Import({
    RestControllerWrapResponseAdvice.class,
    RestControllerWrapExceptionAdvice.class,
    WebConfig.class
})
