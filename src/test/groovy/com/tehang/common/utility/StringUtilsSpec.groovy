...
// ------------ join相关的方法 ----------
  ...
  def "test concat"() {
    expect:
    StringUtils.unionStringLists(null) == List.of()
    StringUtils.unionStringLists(List.of("a", "b"), List.of("c", "d")) == List.of("a", "b", "c", "d")
    StringUtils.unionStringLists(List.of("a", "b", ""), List.of("b", "c", "")) == List.of("a", "b", "", "b", "c", "")
  }
}
